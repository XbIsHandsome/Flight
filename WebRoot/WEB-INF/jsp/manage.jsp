	...
	<div class="container index">
		<div class="span24">
			<table class="table table-bordered table-hover">
				...
				<tr>
					<s:if test="#session.adminFlight != null">
						<s:iterator value="#session.adminFlight" var="f">
							<tr>
								<td><s:property value="#f.fid" /></td>
								<td><s:property value="#f.flight_from" /></td>
								<td><s:property value="#f.flight_to" /></td>
								<td>20<s:property value="#f.flight_time" /></td>
								<td><s:property value="#f.flight_seat" /></td>
								<td><s:property value="#f.flight_price" /></td>
								<td><a
									href="${pageContext.request.contextPath }/flight_delete?fid=<s:property value="#f.fid"/>">删除</a></td>
								<td><a
									href="${pageContext.request.contextPath }/flight_modify?fid=<s:property value="#f.fid"/>">修改</a></td>
							</tr>
						</s:iterator>
						<tr>
							<td>&nbsp;&nbsp;</td>
							...
							<td>&nbsp;&nbsp;</td>
							<td><a
								href="${pageContext.request.contextPath }/flight_add?fid=<s:property value="#f.fid"/>">添加</a></td>
						</tr>
					</s:if>
				</tr>
			</table>
